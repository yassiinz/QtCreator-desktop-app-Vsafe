...
equipmanagement::equipmanagement(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::equipmanagement)
{
    ui->setupUi(this);
...
equipmanagement::~equipmanagement()
{
    delete ui;
}

void equipmanagement::refreshEquip()
{
    proxy2->setSourceModel(e.afficher());
        ui->tableView->setModel(proxy2);
...
void equipmanagement::on_pb_supprimer_2_clicked()
    {
...
void equipmanagement::on_pb_ajouter_clicked()
{
    ...
    equipement e(ref, qte, libelle, type, etat, imageData);
    bool test=e.ajouter();
    if (test)
    {
...
void equipmanagement::on_pushButton_5_clicked()
{
...
void equipmanagement::on_lineEdit_5_textChanged(const QString &arg1)
{
    proxy2->setFilterFixedString(arg1);
}


void equipmanagement::on_pushButton_pdf_clicked()
{
    QString strStream;
...
void equipmanagement::on_pushButton_2_clicked()
{
...
void equipmanagement::on_InsertImage_clicked()
{
    {
...
void equipmanagement::on_btnDisplayImage_clicked()
{
...
void equipmanagement::on_comboBox_2_currentIndexChanged(int index)
{
    ui->tableView->sortByColumn(index,Qt::AscendingOrder);
}

void equipmanagement::on_checkButton_clicked()
{
    int target_number = 2; // Change this to the target number you want to check
